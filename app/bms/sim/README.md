...
## 1. Setup
    ...
    python assets/robots/g1/build_g1_mjcf.py   # builds our G1 MJCF (jacket, boots, ascender) + scene with floor

## 2. Run the demo (robot stands, swings arms; 30 s sim at 5,300 m in −19 °C, 30 km/h wind)
    python app/bms/sim/mujoco_monitor.py --xml assets/robots/g1_himalaya_ascender_scene.xml --seconds 30 --altitude 5300 --wind 30
